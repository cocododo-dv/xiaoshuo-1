...
def test_prompt_templates_teach_both_scene_forms() -> None:
    ...
    expectations = {
        "neutral_draft": ("2026-09-13.v7", "never on a clean win the section did not plan"),
        "style_first_draft": ("2026-09-13.v2", "may not skip the Decision"),
        "scene_blueprint": ("2026-09-13.v5", "derive the proposal from it instead of re-inventing the scene"),
