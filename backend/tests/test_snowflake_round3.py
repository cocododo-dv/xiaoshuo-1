...
def test_round3_prompt_versions_and_contracts() -> None:
    ...
    drafting = {
        ...
        "style_first_draft": ("2026-09-15.v7", ("Author's exception", "the Setback is the last attempt", "proactive or reactive — is told as narrative summary")),
        "hard_qc": ("2026-09-15.v6", ("Author's exception", "is not a violation")),
        "soft_qc": ("2026-09-15.v8", ("story-crucible exposition", "an emotion named", "dragged over pages", "never a gap")),
